            ...
            <div class="span9">
                ...
                <div class="well">
                    <div >
                        ...
                        @if(!isset($DonDatHang[0]))
                            <h4 style="text-align: center">Bạn chưa có lịch sử mua hàng,<a class="one" style="text-decoration: none;" href="{{url('/')}}"> &nbsp;Tiếp tục mua hàng</a>
                        </h4>
                        @else
                            <table class="table">
                                <thead>
                                ...
                                <tbody>
                                    ...
                                    <td>{{$dh->tinh_trang}}</td>
                                    <td>
                                        @if($dh->tinh_trang=='Hoàn tất')
                                            <a href="{{url('khach-hang/danh-gia-san-pham/'.$dh->id_sp)}}">
                                                Đánh giá
                                            </a>
                                        @else
                                        @endif
